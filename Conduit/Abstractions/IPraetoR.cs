namespace PraetoR
{
    ...
    public interface IPraetoR
    {
        ...
        /// <param name="message">The message object that implements IMessage<TResponse>.</param>
        /// <param name="cancellationToken">The token to monitor for cancellation requests.</param>
        /// <returns>
        /// A task that represents the asynchronous operation, 
        /// containing the handler's response.
        /// </returns>
        Task<TResponse> Send<TResponse>(IOperation<TResponse> message, CancellationToken cancellationToken = default);
        /// <summary>
        ...
        /// containing the handler's response.
        /// </returns>
        Task Send(IOperation message, CancellationToken cancellationToken = default);
